---
title: "Delta Smelt Enclosure Study 2019 Hybrid Paper Analysis"
output:
...
```{r}
diet2 <- read_csv("hybrid study/DSM Cage Diets 2019-2020.csv") #new data, not edited at all
...
stomach_abundance$Location <- ordered(stomach_abundance$Location, levels = c("RV.Feb", "RV.Aug", "SM.Nov", "YB.Nov", "RV.Nov"))
...
#order locations
prop$Location <- ordered(prop$Location, levels = c("RV.Feb", "RV.Aug", "SM.Nov", "YB.Nov", "RV.Nov"))
