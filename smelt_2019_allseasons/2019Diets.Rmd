...
stomach_abundance$Location <- ordered(stomach_abundance$Location, levels = c("RV.Feb", "DWSC.Apr", "RV.Aug", "SM.Nov", "YB.Nov", "RV.Nov"))
...
#order locations
prop$Location <- ordered(prop$Location, levels = c("RV.Feb", "DWSC.Apr", "RV.Aug", "SM.Nov", "YB.Nov", "RV.Nov"))
