...
(plot_season_k <- ggplot(data = letter_m1,) + 
  ...
  geom_segment(aes(x = Season, y = emmean, xend = Season, yend = rcmpl, color = .group), size = 6, color = "cadetblue3", lineend = "butt") +
    geom_segment(aes(x = Season, y = emmean, xend = Season, yend = lcmpl, color = .group), size = 6, color = "cadetblue3", lineend = "butt") +
  ...
  labs(y = "Proportional Change in K (g cm^-2) with 95% Confidence Intervals") +
  theme_bw() +
...
(plot_season_wt <- ggplot(data = letter_m2,) + 
  ...
  geom_point( aes(x=Season, y=emmean), size = 2.5, shape = 18) +     
   geom_text( aes(label = .group, x = Season, y = upper.CL + 0.02), position = position_dodge2(width = 0.3)) + 
    geom_hline(yintercept = 0, linetype = "dashed") + 
    viridis::scale_color_viridis(discrete = TRUE, option = "turbo") +
  labs(y = "Proportional Change in Weight (g) with 95% Confidence Intervals") +
  theme_bw() +
...
(plot_Site_k <- ggplot(data = letter_m3,) + 
  ...
  viridis::scale_color_viridis(discrete = TRUE, option = "turbo") +
  labs(y = "Change in K (g cm^-2) with 95% Confidence Intervals") +
  theme_bw() +
  theme(axis.text.x = element_text(size = 11),
        axis.text.y = element_text(size = 11),
        legend.position = "top",
...
(plot_Site_wt <- ggplot(data = letter_m4,) + 
  ...
  geom_segment(aes(x = Site, y = emmean, xend = Site, yend = rcmpl, color = .group), size = 6, color = "cadetblue3", lineend = "butt") +
   ...
   geom_text( aes(label = .group, x = Site, y = upper.CL + 0.03), position = position_dodge2(width = 0.3)) + 
    geom_hline(yintercept = 0, linetype = "dashed") + 
    viridis::scale_color_viridis(discrete = TRUE, option = "turbo") +
  labs(y = "Change in Weight (g) with 95% Confidence Intervals") +
  theme_bw() +
  theme(axis.text = element_text(size = 11),
        legend.position = "top",
        axis.title.x = element_blank()) )
